...
export function ChristmasTreeAnimation() {
  const [phase, setPhase] = useState<"flock" | "forming" | "complete">("flock")
  ...
  return (
    <div className="relative w-full max-h-[400px] h-[400px] overflow-hidden rounded-2xl">
        ...
        {particles.map((particle) => {
          ...
          return (
            <g key={particle.id}>
              ...
              />
              {/* Glow for light particles when tree is formed */}
